...
import {getProductsByBoardId} from "../../../services";
...
class BoardsById extends React.Component {
    ...
    getInitialProducts = async () => {
        try {
            const response = await getProductsByBoardId(this.props.auth.meta.token, this.props.name, 0)
    ...
    loadMoreProducts = async () => {
        ...
        try {
            const response = await getProductsByBoardId(this.props.auth.meta.token, this.props.name, this.state.dataPage)
